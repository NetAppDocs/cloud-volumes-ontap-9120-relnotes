...
// Add required link(s)
* link:media/notice-aws.pdf[Notice for the Cloud Volumes ONTAP 9.12.0 mediator in AWS^]
* link:media/notice-google-cloud.pdf[Notice for the Cloud Volumes ONTAP 9.12.0 mediator in Google Cloud^]
